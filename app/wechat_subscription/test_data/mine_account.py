...
#     {'username': '81011111111', 'password': '123456', 'assert': '请输入正确手机号'},  # 11位数字 - 非手机号
...
#     # {'username': '180111111155678', 'password': '123456'},  # 15位数字  是否限制大于11位输入
#     {'username': '19781111111', 'password': '123123', 'assert': '该手机号尚未注册，请先至学生端注册'},  # 已注册老师账号
#     # {'username': '18011111115', 'password': '123456'},  # 已注册学生账号
...
#     {'username': '13502095382', 'password': '123456'},  # 已注册有老师，学生，校长三重身份   # 基础版学生
#     ]
#
...
phone_data = [
    ...
    {'username': '18711111234', 'password': '123456'},  # 已注册学生账号
    {'username': '18711111134', 'password': '123456'},  # 已注册有老师身份又有学生身份
    {'username': '18711111237', 'password': '123456'},  # 已注册有老师，学生，校长三重身份   # 基础版学生
    ]
