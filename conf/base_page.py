...
from conf.sham_element import ShamElement
...
class BasePage(object):
    ...
    def swipe_up(self, element=None, steps=1):
        """
        swipe up
    ...
    def swipe_down(self, element=None, steps=1):
        """
        swipe down
        :param element: WebElement of Macaca, if None while swipe window of phone
        :param steps: steps of swipe for Android, The lower the faster
